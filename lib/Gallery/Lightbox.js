...
var Lightbox = _react2.default.createClass({
	...
	renderImages: function renderImages() {
		...
		if (images[currentImage].srcset) {
			var img = _react2.default.createElement('img', { src: images[currentImage].src, srcSet: images[currentImage].srcset.join(), sizes: parseInt(this.props.styles.image.maxWidth) + 'vw', style: this.props.styles.image, onTouchEnd: function onTouchEnd(e) {
					return e.stopPropagation();
				}, onClick: function onClick(e) {
					return e.stopPropagation();
				} });
		} else {
			var img = _react2.default.createElement('img', { src: images[currentImage].src, style: this.props.styles.image, onTouchEnd: function onTouchEnd(e) {
					return e.stopPropagation();
				}, onClick: function onClick(e) {
					return e.stopPropagation();
				} });
