...
var DateFilter = function (_Component) {
   ...
   _createClass(DateFilter, [{
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            ...
            _react2.default.createElement(
               ...
               _react2.default.createElement(_antd.Input, { readOnly: 'readonly', value: formatValue, style: { borderTopRightRadius: '0', borderBottomRightRadius: '0' } }),
               _react2.default.createElement(
                  ButtonGroup,
                  { className: 'ant-input-group-wrap', style: { display: 'flex' } },
                  _react2.default.createElement(
                     _antd.Button,
                     { onClick: this.onPreClick.bind(this), disabled: disabledAllBtn || preDisabled, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0' } },
                     '<<<'
                  ),
                  _react2.default.createElement(
                     _antd.Button,
                     { onClick: this.onMonthClick.bind(this), disabled: disabledAllBtn, type: monthBtnType },
                     '月'
                  ),
                  _react2.default.createElement(
                     _antd.Button,
                     { onClick: this.onYearClick.bind(this), disabled: disabledAllBtn, type: yearBtnType },
                     '年'
                  ),
                  _react2.default.createElement(
                     _antd.Button,
                  ...
                  _react2.default.createElement(
                     _antd.Button,
                     { onClick: this.onNextClick.bind(this), disabled: disabledAllBtn || nextDisabled },
                     '>>>'
                  )
               )
            )
      ...
      value: function onNextClick() {
         ...
         var maxYear = _props.maxYear;
         var maxMonth = _props.maxMonth;
