    ...
    value: function rowClick(e) {
      ...
      if (e.target.tagName !== "INPUT" && e.target.tagName !== "SELECT" && e.target.tagName !== "TEXTAREA") {
        (function () {
          ...
          if (_this2.props.selectRow) {
            if (_this2.props.selectRow.clickToSelect) {
              _this2.props.onSelectRow(rowIndex, !_this2.props.isSelected);
            } else if (_this2.props.selectRow.clickToSelectAndEditCell) {
              _this2.clickNum++;
