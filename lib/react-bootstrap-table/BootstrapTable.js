...
var BootstrapTable = function (_Component) {
  ...
  function BootstrapTable(props) {
    ...
    _this.handlePaginationData = function (page, sizePerPage) {
      ...
      var pageStartIndex = _this$props$options.pageStartIndex;
    ...
    _this.state = {
      ...
      currPage: _this.props.options.page || _this.props.options.pageStartIndex || _Const2.default.PAGE_START_INDEX,
