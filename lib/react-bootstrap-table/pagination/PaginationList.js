...
var PaginationList = function (_React$Component) {
  ...
  function PaginationList(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PaginationList).call(this, props));

    _this.documentClick = function (e) {
      ...
      return _react2.default.createElement(
        ...
        this.props.sizePerPageList.length > 1 ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { ref: 'pageDropDown', className: 'btn btn-default dropdown-toggle', type: 'button', id: 'pageDropDown', 'data-toggle': 'dropdown', 'aria-expanded': 'false', onClick: this.pageDropHandle.bind(this) },
